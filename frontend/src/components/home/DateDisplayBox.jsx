      ...
      <div className={styles.groupOuter}>
        <div className={styles.groupInner}>
          <span className={styles.arrow}>
            <img src="/assets/Arrow-back-ios.svg" alt="Previous" width="24" height="24" />
          </span>
          <span className={`${styles.dateText} h4`} style={{color:'#22221B',textAlign:'center'}}>{formatToday()}</span>
          <span className={styles.arrow}>
        ...
        <span className={`${styles.todayText} h5`} style={{color:'rgba(34,34,27,0.60)',textAlign:'center'}}>Today</span>
      </div>
    </div>
  );
} 