...
export default function DailyView({ userEmail, isLoggedIn, selectedDate }) {
  ...
  useEffect(() => {
    setActiveDate(selectedDate || new Date());
  }, [selectedDate]);
  ...
  useEffect(() => {
    ...
    let from = new Date(activeDate);
    let to = new Date(activeDate);
    ...
    <div>
      ...
      <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:8}}>
        <div style={{fontWeight:700,fontSize:18}}>
          {activeDate && activeDate.toLocaleDateString('en-US', { weekday:'long', year:'numeric', month:'2-digit', day:'2-digit' })}
        </div>
