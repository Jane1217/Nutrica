...
export default function ForgotPassword({ open, onClose, onBackToLogin }) {
  ...
  return (
    <ModalWrapper open={open} onClose={onClose}>
      <main className={styles.forgotPasswordMainContent}>
        <header className={styles.forgotPasswordHeader}>
          <div className={styles.headerRow}>
            <div className={`${styles.forgotPasswordOverline2} h2`}>Forgot Password</div>
        ...
        <div className={styles.forgotPasswordInstruction}>
          <p className="body1">Enter the email address you used to sign up, and we'll send you a link to reset your password.</p>
        </div>
        ...
        <div className={styles.actionGroup}>
          <button className={`${styles.resetPasswordBtn} h5`} onClick={handleResetPassword}>
            Log in
          </button>
        </div>
        
        <div className={styles.actionModule}>
          <button className={`${styles.backToLoginBtn} h5`} onClick={onBackToLogin}>
            Back to Login
          </button>
        </div>
      </main>
