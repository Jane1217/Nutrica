      ...
      <main className={styles.signupMainContent}>
        <header className={styles.signupHeader}>
          <div className={styles.headerRow}>
            <div className={`${styles.signupOverline2} h1`}>Forgot Password</div>
        ...
        {!showSuccess ? (
          <>
            <div className={styles.inputWrapper}>
              <div className="body1" style={{marginBottom: 16}}>
          ...
          <>
            {/* Success Icon */}
            <div className={resetPasswordStyles.forgotPasswordSuccessIcon}>
            ...
            {/* Success Message */}
            <p className={`${resetPasswordStyles.forgotPasswordSuccessMessage} body1`}>
              If your email address is in our system, you'll<br />
